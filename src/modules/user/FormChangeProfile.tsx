...
import { genderBD, genreBD, groupeOptions, profilePrivacySettings, sityBD, skillBD } from "../authorization/service/BD";
...
export const FormChangeProfile = ({ userDataProfile }: FormChangeProfileType) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className={s.formChangeProfile}>
        ...
        <Controller
          ...
          render={({ field: { onChange, value, ref, ...field } }) => (
            <div className={s.textarea}>
              <TextAreaElement ItemRef={ref} value={value} onChange={onChange} placeholderValue="Указать" {...field} />
      ...
      <div className={s.selectField}>
        ...
        <Controller
          ...
          control={control}
          render={({ field: { onChange, value, ref, ...field } }) => (
            <ReactSelectElement ItemRef={ref} value={value} placeholder="Выбрать" options={skillBD} onChange={onChange} {...field} />
          )}
        />
      </div>
      ...
      <div className={s.btnFormWrapper}>
        <BtnInFormSaveCancel textCancelButton="Отмена" textButton="Сохранить" />
      </div>
    </form>
  );
};
