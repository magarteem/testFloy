...
export const CreateNewAds = () => {
  ...
  return (
    <FormLayoutCreateADS textLabel={titleForm} arrowCanselImgIcon={cancelImgIcon}>
      <ButtonGroupe checked={checked} showVacancyButton={showVacancyButton} showAdsButton={showAdsButton} />

      {checked ? (
        <FormProvider {...methodVacancy}>
          <form noValidate className={s.formVacancy} onSubmit={methodVacancy.handleSubmit(onSubmitVacancy)}>
            <CreateFormVacancy />
