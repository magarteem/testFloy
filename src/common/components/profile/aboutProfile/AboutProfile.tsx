  ...
  return (
    <>
      <section className={s.main}>
        <NameProfile age={userDataProfile.age} name={userDataProfile.name} sity={userDataProfile.sity ? userDataProfile.sity.label : ""} />
        ...
        <WorkEducationeCards workEducationeData={userDataProfile.skills.workExperience} skillsCategoryTitle="Опыт работы" />
        <WorkEducationeCards workEducationeData={userDataProfile.skills.education} skillsCategoryTitle="Образование" />
        {userDataProfile.skills.master && <SkillsLayout skillsDataItem={userDataProfile.skills.master.label} skillsCategoryTitle="Мастерство" />}
