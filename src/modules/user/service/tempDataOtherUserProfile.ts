...
import { OneUserProfileType } from "../types/typeTempDataOtherUserProfile";

export const tempDataOtherUserProfile: OneUserProfileType[] = [
  {
    id_user: "vova",
    name: "Вова Петров",
  ...
  },
  {
    ...
    skills: {
      ...
      education: [
        {
          img: avatar_1,
          institution: "Российская Академия музыки им. Гнесеных",
          period: "2017-2019",
        },
        {
          img: avatar_2,
          institution: "Национальная Академия музыки им. Шевченко",
          period: "206-2018",
        },
        {
          img: avatar_3,
      ...
      inspiration: [Inspiration_1, Inspiration_2, Inspiration_1],
    },
    private_settings: "",
  },
  {
    ...
    skills: {
      ...
      workExperience: [
        { img: avatar_1, institution: "Бар “Джаз”", period: "2010-2021" },
        {
          img: avatar_2,
          institution: "Ресторан “Гармония”",
          period: "2016-2020",
