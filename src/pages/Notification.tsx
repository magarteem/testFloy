...
export const Notification = () => {
  return (
    <>
      <div className={s.tempStyle} style={{ display: "flex", flexDirection: "column" }}>
        <div>
          Notification
          <br /> (в разработке)
        </div>
        ...
        <div>
          ...
          <Link to={`${RouteNames.OTHER_PROFILE_USER}/ulia`} style={{ margin: "10px" }}>
            Юлия
          </Link>
          <Link to={`${RouteNames.OTHER_PROFILE_USER}/masha`} style={{ margin: "10px" }}>
            Маша
          </Link>
        </div>
      </div>
