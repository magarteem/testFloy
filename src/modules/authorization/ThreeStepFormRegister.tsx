...
import { genderBD, genreBD, groupeOptions, profilePrivacySettings, sityBD, skillBD } from "./service/BD";
    ...
    <div className={s.threeStepFormRegister}>
      ...
      <div className={s.main}>
          ...
          <Controller
            ...
            render={({ field: { onChange, ref, ...field } }) => (
              <div className={s.sizeInput}>
                <Input ItemRef={ref} placeholder="Ваше имя" onChange={onChange} errors={errors.name_field && errors.name_field.message} {...field} />
              </div>
            )}
          />
        </div>
        ...
        <div className={s.selectField}>
          ...
          <Controller name="img_upload" control={control} render={({ field: { onChange, ...field } }) => <UploadPhoto register={register} />} />
        </div>
        ...
        <div className={s.selectField}>
          ...
          <Controller
            ...
            render={({ field: { onChange, ref, ...field } }) => (
              <ReactSelectElement ItemRef={ref} placeholder="Выбрать" options={genderBD} onChange={onChange} errors={errors.gender} {...field} />
            )}
          />
        </div>
        ...
        <div className={s.selectField}>
          ...
          <Controller
            ...
            render={({ field: { onChange, ref, ...field } }) => (
              <CustomReactSelectGenre ItemRef={ref} placeholder="Выбрать" options={genreBD} onChange={onChange} errors={errors.genre} {...field} />
            )}
          />
        </div>
          ...
          <Controller
            ...
            render={({ field: { onChange, ref, ...field } }) => (
              <div className={s.textarea}>
                <TextAreaElement ItemRef={ref} onChange={onChange} placeholderValue="Указать" {...field} />
        ...
        <div className={s.selectField}>
          ...
          <Controller
            ...
            control={control}
            render={({ field: { onChange, ref, ...field } }) => (
              <ReactSelectElement ItemRef={ref} placeholder="Выбрать" options={skillBD} onChange={onChange} {...field} />
            )}
          />
        </div>
        ...
        <div className={s.selectField}>
          <InputLabel required titleSelect="Настройки приватности анкеты" />
          <Controller
      ...
      <div className={s.btnFormWrapper}>
        <BtnInFormSaveCancel textCancelButton="Назад" textButton="Создать анкету" />
      </div>
    </div>
  );
};
