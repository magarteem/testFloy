...
const authSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(authThunkLogin.fulfilled.type, (state: InitialStateType, actions: PayloadAction<string>) => {
        Cookies.set('auth-token', `${actions.payload}`)
        state.isAuth = !!actions.payload;
      })
      .addCase(authThunkLogin.rejected.type, (state: InitialStateType, actions: PayloadAction<string>) => {
